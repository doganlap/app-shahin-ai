...
{
    /// <inheritdoc />
    public partial class AddTenantCreationFingerprint : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FacilityType = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    ...
                    ManagerPhone = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    ...
                    SecurityContactName = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    SecurityContactPhone = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    ...
                    ComplianceFrameworksJson = table.Column<string>(type: "text", nullable: true),
                    ...
                    HasBackupPower = table.Column<bool>(type: "boolean", nullable: false),
                    HasEnvironmentalMonitoring = table.Column<bool>(type: "boolean", nullable: false),
                    OwnershipType = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    LeaseExpirationDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    MonthlyCost = table.Column<decimal>(type: "numeric", nullable: true),
                    AnnualBudget = table.Column<decimal>(type: "numeric", nullable: true),
                    ...
                    LastInspectionDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    NextInspectionDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    LastAuditDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    NextAuditDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "TenantCreationFingerprints",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TenantCreationFingerprints", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_TenantUsers_FacilityId",
                table: "TenantUsers",
                column: "FacilityId");

            migrationBuilder.CreateIndex(
                name: "IX_Risks_FacilityId",
                table: "Risks",
                column: "FacilityId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Risks_Facilities_FacilityId",
                table: "Risks",
                column: "FacilityId",
                principalTable: "Facilities",
                principalColumn: "Id");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_TenantUsers_Facilities_FacilityId",
                table: "TenantUsers",
                column: "FacilityId",
                principalTable: "Facilities",
                principalColumn: "Id");
