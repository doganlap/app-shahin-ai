        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: true),
                    ControlAssessmentId = table.Column<Guid>(type: "uuid", nullable: true),
                    ...
                    AiClassification = table.Column<JsonDocument>(type: "jsonb", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JurisdictionEn = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    JurisdictionAr = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    ...
                    ContactAddress = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: false),
                    ExtraProperties = table.Column<string>(type: "text", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Category = table.Column<int>(type: "integer", nullable: false),
                    InherentProbability = table.Column<int>(type: "integer", nullable: false),
                    ...
                    ResidualProbability = table.Column<int>(type: "integer", nullable: true),
                    ResidualImpact = table.Column<int>(type: "integer", nullable: true),
                    ResidualRiskLevel = table.Column<int>(type: "integer", nullable: true),
                    RiskOwnerId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    RegulatorId = table.Column<Guid>(type: "uuid", nullable: false),
                    Code = table.Column<string>(type: "text", nullable: false),
                    ...
                    SunsetDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    OfficialDocumentUrl = table.Column<string>(type: "text", nullable: false),
                    ExtraProperties = table.Column<string>(type: "text", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Frameworks_Regulators_RegulatorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RiskControlLink", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RiskControlLink_Risks_RiskId",
                        column: x => x.RiskId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicabilityCriteria", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ApplicabilityCriteria_Frameworks_FrameworkId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TitleEn = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: false),
                    TitleAr = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: false),
                    RequirementEn = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: false),
                    RequirementAr = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: false),
                    GuidanceEn = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: false),
                    GuidanceAr = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: false),
                    Type = table.Column<int>(type: "integer", nullable: false),
                    Category = table.Column<int>(type: "integer", nullable: true),
                    MaturityLevel = table.Column<int>(type: "integer", nullable: false),
                    Priority = table.Column<int>(type: "integer", nullable: false),
                    EvidenceTypes = table.Column<List<string>>(type: "text[]", nullable: false),
                    EstimatedEffortHours = table.Column<int>(type: "integer", nullable: false),
                    MappingISO27001 = table.Column<string>(type: "text", nullable: false),
                    MappingNIST = table.Column<string>(type: "text", nullable: false),
                    MappingCOBIT = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FrameworkDomains_Frameworks_FrameworkId",
                        column: x => x.FrameworkId,
                        principalTable: "Frameworks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetFrameworkCode = table.Column<string>(type: "text", nullable: false),
                    TargetControlNumber = table.Column<string>(type: "text", nullable: false),
                    MappingStrength = table.Column<string>(type: "text", nullable: false),
                    Notes = table.Column<string>(type: "text", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    ControlId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ControlMapping_Controls_ControlId",
                        column: x => x.ControlId,
                        principalTable: "Controls",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicabilityCriteria_FrameworkId",
                table: "ApplicabilityCriteria",
                column: "FrameworkId");

            migrationBuilder.CreateIndex(
                name: "IX_ControlMapping_ControlId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FrameworkDomains_FrameworkId",
                table: "FrameworkDomains",
                column: "FrameworkId");

            migrationBuilder.CreateIndex(
                name: "IX_Frameworks_RegulatorId",
                table: "Frameworks",
                column: "RegulatorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RiskControlLink_RiskId",
                table: "RiskControlLink",
                column: "RiskId");
