...
/// <summary>
/// Workflow definition (BPMN-style) with bilingual support
/// </summary>
public class WorkflowDefinition : FullAuditedAggregateRoot<Guid>
{
    ...
    public WorkflowDefinition(Guid id, LocalizedString name, LocalizedString description, string version, string bpmnXml, string category)
        : base(id)
    {
