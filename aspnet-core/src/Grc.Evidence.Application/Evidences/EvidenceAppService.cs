...
using EvidenceEntity = Grc.Evidence.Evidence;
...
{
    private readonly IRepository<EvidenceEntity, Guid> _evidenceRepository;
    ...
    public EvidenceAppService(
        IRepository<EvidenceEntity, Guid> evidenceRepository,
    ...
    public async Task<EvidenceDto> UploadAsync(Guid? controlAssessmentId, IFormFile file, string description = null)
    {
        ...
        if (tenantId.HasValue)
        {
            ...
            //     (decimal)fileSizeMB);
            var allowed = true; // TODO: Re-enable when Product module is available
        ...
        if (tenantId.HasValue)
        {
            ...
            //     QuotaType.EvidenceStorageMB,
            //     (decimal)fileSizeMB);
            // TODO: Re-enable when Product module is available
        }
        ...
        return ObjectMapper.Map<EvidenceEntity, EvidenceDto>(evidence);
    }
